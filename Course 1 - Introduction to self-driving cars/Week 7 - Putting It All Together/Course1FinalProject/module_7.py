...
def exec_waypoint_nav_demo(args):
    ...
    with make_carla_client(args.host, args.port) as client:
        ...
        print(os.getcwd())
        '''if ('D:\Carla\CarlaSimulator\PythonClient\Course1FinalProject\racetrack_waypoints.txt'):
            waypoints_file = 'D:\Carla\CarlaSimulator\PythonClient\Course1FinalProject\racetrack_waypoints.txt'
            print("Yes the file Exixts")
        else:
            print("No !!")'''
        waypoints_np   = None
